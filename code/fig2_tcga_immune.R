...
ggsave("../results/figS2c.pdf", width = 4, height = 3)
...
res_df <- data.frame(p = res$p.value,
                     ...
                     alternative = res$alternative,
                     data = res$data.name)
write.csv(res_df,  "../results/figS2c_ttest_res.csv", row.names = FALSE)
